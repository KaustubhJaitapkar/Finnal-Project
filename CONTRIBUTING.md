...
Thank you for considering contributing to HackMate We welcome all contributions, whether it's fixing bugs, adding new features, improving documentation, or suggesting ideas. Please take a moment to read through the following guidelines before submitting a contribution.
...
### 1. Reporting Bugs
- Ensure the issue was not already reported by searching [existing issues](https://github.com/harsh3dev/HackMate/issues).
...
- Check if the enhancement is already proposed in [existing issues](https://github.com/harsh3dev/HackMate/issues).
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/harsh3dev/HackMate
   cd HackMate
