...
export default function OldJobDetails() {
  ...
  const handleApplySubmit = () => {
    if (linkedinUrl && githubUrl && resume) {
      ...
      console.log("Applying with LinkedIn:", linkedinUrl, "GitHub:", githubUrl, "and Resume:", resume?.name || 'no file provided')
      if (!resume) {
        // warn in console but allow the user to continue (some users keep resume in profile)
        console.warn('No resume file provided at submit time — ensure your profile has a resume or upload one.')
      }
