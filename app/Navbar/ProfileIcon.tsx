        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56">
                <DropdownMenuGroup>
                    ...
                    {/* <DropdownMenuItem className="cursor-pointer" >
                        <Link href={`/dashboard/my-applications`} className="w-full flex justify-between items-center">
                            <span> Application status </span>
                        </Link>
                    </DropdownMenuItem> */}
                    <DropdownMenuItem className="cursor-pointer" >
                        <Link href={`/dashboard/requests`} className="w-full flex justify-between items-center">
